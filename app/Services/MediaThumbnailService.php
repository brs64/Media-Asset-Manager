...
protected string $ffastransThumbnailsPath;
protected string $thumbnailSuffix = '_miniature.jpg';

protected FfastransService $ffastrans;
...
public function __construct(FfastransService $ffastrans)
{
    ...
    $this->ffastransThumbnailsPath = config('services.ffastrans.thumbnails_path', '/mnt/miniatures');
...
public function regenerateMissingThumbnails(): array
{
 ...
 public function generateThumbnailWithFfmpeg(Media $media, ?string $videoPath = null, bool $force = false): ?string
 {
     $thumbnailFilename = $media->id . $this->thumbnailSuffix;
     $thumbnailPath = $this->thumbnailsPath . '/' . $thumbnailFilename;
     ...
     // Priority: chemin_local > ARCH > PAD
